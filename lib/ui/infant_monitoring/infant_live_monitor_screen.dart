...
class InfantLiveMonitorScreen extends StatelessWidget {
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            // Middle: Camera placeholder (for Pi stream later)
            Expanded(
              child: Container(
                width: double.infinity,
                decoration: BoxDecoration(
            ...
            // Bottom: dummy AI status chips (for future Pi+AI data)
            Row(
